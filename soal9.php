                ...
                <main>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grafik Total Jumlah Tiap Produk</li>
                        </ol>
                        <div class="row">
                          <div class="col-xl-6">
                            <!-- INI -->
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT dim_product.ProductName, fact_sales.Sales_Amount FROM `dim_product` INNER JOIN fact_sales ON dim_product.ProductID=fact_sales.ProductID GROUP BY ProductName");

                            while ($row = mysqli_fetch_array($query1)) {
                                $product_name[] = $row['ProductName'];
                                $sales_amount[] = $row['Sales_Amount'];

                                $product_name_string = "'" . implode("','", $product_name) . "'";
                                $sales_amount_string = implode(",", $sales_amount);
                            }
                            ?>
                            ...
                            <script>
                                ...
                                var myChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: 'Grafik Total Penjualan Tiap Produk',
                                            data: <?php echo json_encode($sales_amount); ?>,
