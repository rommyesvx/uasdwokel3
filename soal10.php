                ...
                <main>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grafik Total Jumlah Tiap Kategori</li>
                        </ol>
                        <div class="row">
                          <div class="col-xl-6">
                            <!-- INI -->
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT * FROM soal10");

                            while ($row = mysqli_fetch_array($query1)) {
                                $country_name[] = $row['CategoryName'];

                                $query2 = mysqli_query($conn, "SELECT sum(TotalQuantity) as TotalJumlah from soal10 where CategoryName='" . $row['CategoryName'] . "'");
                                $row2 = $query2->fetch_array();
                                $total_pendapatan[] = $row2['TotalJumlah'];
                            }
                            ?>
                            ...
                            <script>
                                ...
                                var myChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: 'Grafik Total Jumlah Tiap Kategori',
