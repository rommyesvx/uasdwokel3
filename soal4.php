                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                          <div class="col-xl-6">
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT dim_product.ProductName, SUM(fact_sales.Sales_Amount) AS TotalSales FROM `dim_product` INNER JOIN fact_sales ON dim_product.ProductID=fact_sales.ProductID GROUP BY dim_product.ProductName;;
                            ");
                            ...
                            while ($row = mysqli_fetch_array($query1)) {
                                ...
                                $total_sales_string = implode(",", $total_sales);
                            }
                            ?>
