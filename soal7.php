                ...
                <main>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grafik Total Unit terjual tiap negara</li>
                        </ol>
                        <div class="row">
                          <div class="col-xl-6">
                            <!-- INI -->
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT * FROM soal7");

                            while ($row = mysqli_fetch_array($query1)) {
                                $country_name[] = $row['CountryName'];

                                $query2 = mysqli_query($conn, "SELECT sum(TotalUnitsSold) as TotalPenjualan from soal7 where CountryRegionCode='" . $row['CountryRegionCode'] . "'");
                            ...
                            <script>
                                ...
                                var myChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: 'Grafik Total Unit Terjual',
