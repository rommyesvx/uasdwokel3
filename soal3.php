                ...
                <main>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grafik Penjualan ke Tiap Negara</li>
                        </ol>
                        <div class="row">
                          <div class="col-xl-6">
                            <!-- INI -->
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT * FROM soal3");

                            while ($row = mysqli_fetch_array($query1)) {
                                $country_name[] = $row['CountryName'];

                                $query2 = mysqli_query($conn, "SELECT sum(TotalRevenue) as TotalPendapatan from soal3 where CountryRegionCode='" . $row['CountryRegionCode'] . "'");
                                $row2 = $query2->fetch_array();
                                $total_pendapatan[] = $row2['TotalPendapatan'];
                            }
                            ?>
                            <script>
