                ...
                <main>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grafik Total Pendapatan per kategori</li>
                        </ol>
                        <div class="row">
                          <div class="col-xl-6">
                            <!-- INI -->
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT dim_product.categoryName, SUM(fact_revenue.Revenue) AS TotalRevenue
                            FROM dim_product
                            INNER JOIN fact_revenue ON dim_product.ProductID = fact_revenue.ProductID
