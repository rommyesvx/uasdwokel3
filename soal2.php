                ...
                <main>
                    <div class="container-fluid px-4">
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Grafik Total Penjualan 2001-2004</li>
                        </ol>
                        <div class="row">
                          <div class="col-xl-6">
                            <!-- INI -->
                            ...
                            <?php
                            include 'koneksi.php';
                            $query1 = mysqli_query($conn, "SELECT * FROM soal2");

                            while ($row = mysqli_fetch_array($query1)) {
                                $country_name[] = $row['Tahun'];

                                $query2 = mysqli_query($conn, "SELECT sum(TotalPenjualan) as TotalPenjualan from soal2 where Tahun='" . $row['Tahun'] . "'");
                                $row2 = $query2->fetch_array();
                                $total_pendapatan[] = $row2['TotalPenjualan'];
                            }
                            ?>
                            <div style="width: 600px;height: 400px">
                                <canvas id="myChart"></canvas>
                            ...
                            <script>
                                ...
                                var myChart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: 'Grafik Total Pendapatan 2001-2004',
